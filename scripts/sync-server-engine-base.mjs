...
fs.writeFileSync(path.join(root, 'lib/game-engine-base.ts'), '// GENERATED from src/game.ts. Do not hand-edit.\n' + body.trimStart());
console.log('Synced lib/game-engine-base.ts from src/game.ts');
