  ...
  return (
    <html lang="en" className={brastaDisplay.variable}>
      <head>
        ...
        <link rel="stylesheet" href="/player-progression.css?v=0.1.0" />
      ...
      <body>
        ...
        <Script src="/player-progression.js?v=0.1.0" strategy="afterInteractive" />
        ...
        <Script src="/lobby-polish.js?v=12" strategy="afterInteractive" />
        ...
        <Script src="/brasta-special-moves.js?v=0.5.0" strategy="afterInteractive" />
