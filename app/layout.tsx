  ...
  return (
    <html lang="en" className={brastaDisplay.variable}>
      <head>
        ...
        <link rel="stylesheet" href="/no-scroll-layout.css?v=0.1.3" />
      </head>
      <body>
        {children}
        ...
        <Script src="/competitive-2v2-ui.js?v=0.8.4" strategy="afterInteractive" />
        ...
        <Script src="/no-scroll-layout.js?v=0.1.1" strategy="afterInteractive" />
