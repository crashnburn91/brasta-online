  ...
  return (
    <html lang="en" className={brastaDisplay.variable}>
      <head>
        ...
        <link rel="stylesheet" href="/avatar-editor.css?v=0.1.2" />
      ...
      <body>
        ...
        <Script src="/profile-badges.js?v=0.2.1" strategy="afterInteractive" />
        <Script src="/player-card-avatars.js?v=0.1.1" strategy="afterInteractive" />
        <Script src="/cosmetics.js?v=0.3.1" strategy="afterInteractive" />
        ...
        <Script src="/avatar-editor.js?v=0.1.2" strategy="afterInteractive" />
        ...
        <Script src="/deal-animation.js?v=0.1.3" strategy="afterInteractive" />
        ...
        <Script src="/brasta-special-moves.js?v=0.9.1" strategy="afterInteractive" />
